...
![X-Y 分布画像出力](../images/xy_value_map.png)
...
1. **左パネル**  
   ...
   - 出力ステップ範囲、余白、フォントサイズ、出力ボタン

2. **右上: プレビュー**  
   - Matplotlib ベース。ROI ローカル座標で描画し、出力オプションを反映  
...
4. **色とスケールを設定**  
   ...
   - 手動の場合は範囲スライダーでも調整できます。自動計算値を範囲として保持します。
...
6. **出力ステップ範囲を設定**  
   - 開始/終了ステップと間引き数を入力またはレンジスライダーで指定  
   - 範囲外の値は自動で補正されます。
